# Prepared proposal dossier — Karan yadav

Platform: Freelancer.com
Source: https://www.freelancer.com/projects/data-entry/karan-yadav
...
Karan yadav 6 days left I’m after a cohesive mini-package of visual assets for a product-focused campaign. First, I need a bold and colorful YouTube thumbnail that immediately signals “product review” and drives clicks. The design should balance eye-catching color blocks, a clear product image, and punchy headline text that still reads well on mobile. Alongside the thumbnail, I want an Instagram Story sequence whose sole purpose is to promote the same product. Think engaging motion or subtle animation, quick captions, and a compelling call-to-action that nudges viewers to tap through. Finally, I’d like a matching Instagram feed post so the brand look stays consistent across platforms. Deliverables: • 1 high-resolution YouTube thumbnail (16:9, optimized for 1280×720) •... Content Writing Data Entry Script Writing $6 - $16 $6 - $16 0 bids Bid now Data entry! Real data collection from Trustpilot and Google My Business (maps) 6 days left
