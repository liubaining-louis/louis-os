# Prepared proposal dossier — Create 26 Technical Course PDFs

Platform: Freelancer.com
Source: https://www.freelancer.com/projects/technical-writing/create-technical-course-pdfs
...
Create 26 Technical Course PDFs 6 days left I’m putting together a full library of self-study material for intermediate learners and need an experienced technical writer / course creator to craft 26 comprehensive PDFs. Each title below must be delivered as a separate, press-ready document of roughly 400–500 pages, set in 10-point body text, and organised as a clear step-by-step tutorial. Deliverables (one PDF per topic) • Advanced Machine Learning with Python • Full-Stack Web Development with MERN • Cybersecurity Fundamentals & Hacking • UI/UX Design Masterclass (Figma) • Cloud Computing Architect with AWS • Mobile App Development with Flutter • Python Masterclass for Data Science • React.js Frontend Bootcamp • Complete Digital Marketing Guide • Nod... Content Development CSS Git HTML JavaScript MERN Technical Writing Web Development $16 - $131 $16 - $131 0 bids Bid now
