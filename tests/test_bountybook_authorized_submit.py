...
class BountyBookAuthorizedSubmitTests(unittest.TestCase):
    def test_executes_exact_claim_and_inline_submission(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            submitted_file = submit[2]["outputData"]["files"][0]
            self.assertEqual(submitted_file["sha256"], ARTIFACT_SHA256)
            self.assertEqual(submitted_file["content"], ARTIFACT.read_text(encoding="utf-8"))
